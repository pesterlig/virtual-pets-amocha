...
public class ClientOldVirtualPetShelterApp {

	public static void main(String[] args) {
		ShelterOldVirtualPet lesliesCathouse = new ShelterOldVirtualPet();
		Scanner input = new Scanner(System.in);

		OldVirtualPet cat1 = new OldVirtualPet("Finnie", "ginger-striped American shorthair", 0, 100, 100, 100.0);
		lesliesCathouse.inTake(cat1);
		OldVirtualPet cat2 = new OldVirtualPet("Foggy", "kick-ass cat", 50, 50, 50, 50.0);
		...
		System.out.println("There are " + lesliesCathouse.getNumberOfPetsInShelter() + " cats in the shelter today.");
		 ...
		 System.out.println("\nHey! Ho! Let's Go! \nCheck out all our awesome cats
		 below:\n");
		 displayAsciiKitten();
		 // Show names and descriptions, play with cat, show specific cat's values,
		 print
